...
export const Categories = ({categories, selectedCategory, setSelectedCategory}:CategoryProps
) => {
    ...
    return(
        <div ref={containerRef}  className="overflow-x-hidden relative">
            ...
            variant={selectedCategory === category ? "dark":"default"} className="py-1 px-3 rounded-lg whitespace-nowrap font-roboto font-medium text-base">{category}</Button>
            </>
        ) )}
            </div>
            {isLeftArrowVisible && (
